...
function SignUp(props) {
    ...
    return (
        <SignLayout>
            <h1>회원가입</h1>
            <div css={S.inputBox}> <label>이메일</label> <input type="email" name='email' placeholder='이메일을 입력하세요' onChange={handleInputChange}/></div><button onClick={handleCheckEmailDuplicate}>중복 확인</button>
            ...
            <div css={S.inputBox}> <label>이름</label> <input type="text" name='name' placeholder='이름을 입력하세요' onChange={handleInputChange}/></div>
